    ...
    mapper(nullptr)
{
    ...
    ui->blockleAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->blockleAtStartup);
    ...
    ui->blockleAtStartup->setToolTip(ui->blockleAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->blockleAtStartup->setText(ui->blockleAtStartup->text().arg(PACKAGE_NAME));

    ui->openblockleConfButton->setToolTip(ui->openblockleConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new blockleUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->blockleAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openblockleConfButton_clicked()
{
