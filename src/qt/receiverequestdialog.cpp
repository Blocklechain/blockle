...
#include <config/blockle-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatblockleURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + blockleUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatblockleURI(info));
}
