    ...
    platformStyle(_platformStyle)
{
    ...
    // normal blockle address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying blockle address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &blockleAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
