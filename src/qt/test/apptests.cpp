...
//! Entry point for blockleApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &blockleApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for blockleGUI tests.
void AppTests::guiTests(blockleGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &blockleGUI::consoleShown, this, &AppTests::consoleTests);
