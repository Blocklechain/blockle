...
static void SetupBlockleTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " blockle-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  blockle-tx [options] <hex-tx> [commands]  Update hex-encoded blockle transaction\n" +
            "or:     blockle-tx [options] -create [commands]   Create hex-encoded blockle transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blockle transaction
