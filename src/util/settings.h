// Copyright (c) 2019-2020 The Blockle Core developers
...
//!       https://github.com/blockle/blockle/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored blockle settings. This struct combines settings from the command line
