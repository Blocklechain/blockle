...
/* A AEAD class for ChaCha20-Poly1305@blockle.
 *
 ...
 *
 * The chacha20-poly1305@blockle combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@blockle cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@blockle are relatively fast in
