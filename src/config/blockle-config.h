/* src/config/blockle-config.h.  Generated from blockle-config.h.in by configure.  */
/* src/config/blockle-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PALLADIUM_CONFIG_H

#define PALLADIUM_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Blockle Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Blockle Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NotRin7/blockle/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Blockle Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Blockle Core 1.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "blockle"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://blockle-coin.com/"
