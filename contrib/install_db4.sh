...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the blockle repository."
  exit 1
fi
...
# See https://github.com/blockle/blockle/issues/16064
...
echo 'When compiling blockled, run `./configure` in the following way:'
echo
