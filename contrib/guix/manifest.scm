...
(define* (make-blockle-cross-toolchain target
                                  #:key
...
desirable for building Blockle Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-blockle-cross-toolchain "i686-linux-gnu")
       (make-blockle-cross-toolchain "x86_64-linux-gnu")
       (make-blockle-cross-toolchain "aarch64-linux-gnu")
       (make-blockle-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-blockle-cross-toolchain "riscv64-linux-gnu"
