# Bootstrappable Blockle Core Builds

This directory contains the files necessary to perform bootstrappable Blockle
Core builds.
...
- 24GB of free disk space on the partition that the Blockle Core git repository
  resides in
...
For a Blockle Core depends development environment, simply invoke
...
From the top of a clean Blockle Core repository:
...
To use dongcarl's substitute server for Blockle Core builds after having
