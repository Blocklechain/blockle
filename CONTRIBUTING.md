Contributing to Blockle Core
============================

The Blockle Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/blockle/blockle/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Blockle Core PR Review Club](https://blocklecore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Blockle Core development happens on IRC, in the
#blockle-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/blockle-core-dev/](http://www.erisian.com.au/blockle-core-dev/)
and [http://gnusha.org/blockle-core-dev/](http://gnusha.org/blockle-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/blockle-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to blockle-qt
...
[Translation Process](https://github.com/blockle/blockle/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Blockle Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Blockle
Network Protocol consensus changes.

Whether a pull request is merged into Blockle Core rests with the project merge
...
Patches that change Blockle consensus rules are considerably more involved than
...
Where a patch set proposes to change the Blockle consensus, it must have been
...
https://github.com/blockle/blockle/pull/16189).

Also see the [backport.py script](
https://github.com/blockle-core/blockle-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Blockle Core release.
