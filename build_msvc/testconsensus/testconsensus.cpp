...
// blockle includes.
#include <..\src\script\blockleconsensus.h>
...
int main()
{
    std::cout << "blockleconsensus version: " << blockleconsensus_version() << std::endl;
    ...
    auto op0Result = blockleconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, blockleconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
