...
"""Verify that starting blockle with -h works as expected."""

from test_framework.test_framework import BlockleTestFramework
from test_framework.util import assert_equal

class HelpTest(BlockleTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blockle with -h for help text")
        ...
        self.log.info("Start blockle with -version for version information")
        ...
        self.log.info("Start blockled with -fakearg to make sure it does not start")
