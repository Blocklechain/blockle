...
By default, blockled will dump mempool on shutdown and
...
class MempoolPersistTest(BlockleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent blockled from writing mempool.dat to disk. Verify that `savemempool` fails")
