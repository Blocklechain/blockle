...
class TestShell:
    """Wrapper Class for BlockleTestFramework.

    The TestShell class extends the BlockleTestFramework
    ...
    class __TestShell(BlockleTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BlockleTestFramework child class.
            self.num_nodes = 1
